...
var import_react$7, import_react$8, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext$1, hasOwn, getLastPart, getFunctionNameFromStackTraceLine, internalReactFunctionNames, sanitizeIdentifier, getLabelFromStackTrace, typePropName, labelPropName, createEmotionProps, Insertion$2, Emotion, Emotion$1;
var init_emotion_element_489459f2_browser_development_esm = __esmMin((() => {
	...
	ThemeContext$1 = /* @__PURE__ */ import_react$7.createContext({});
	...
	Emotion = /* @__PURE__ */ withEmotionCache(function(props, cache, ref) {
		...
		var serialized = serializeStyles(registeredStyles, void 0, import_react$7.useContext(ThemeContext$1));
...
var init_emotion_react_browser_development_esm = __esmMin((() => {
	...
	Global = /* @__PURE__ */ withEmotionCache(function(props, cache) {
		...
		var serialized = serializeStyles([styles], void 0, import_react$6.useContext(ThemeContext$1));
	...
	ClassNames = /* @__PURE__ */ withEmotionCache(function(props, cache) {
		...
		var content = {
			...
			theme: import_react$6.useContext(ThemeContext$1)
		};
		...
		return function() {
			...
			var Styled = withEmotionCache(function(props, cache, ref) {
				...
				if (props.theme == null) {
					...
					mergedProps.theme = import_react$5.useContext(ThemeContext$1);
				}
...
function GlobalStyles$1(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(Global, { styles: typeof styles === "function" ? (themeInput) => styles(isEmpty$1(themeInput) ? defaultTheme : themeInput) : styles });
}
...
function createBreakpoints(breakpoints) {
	const { values = {
		...
		lg: 1200,
		xl: 1536
	}, unit = "px", step = 5 } = breakpoints, other = _objectWithoutPropertiesLoose(breakpoints, _excluded$12);
...
var _excluded$12, sortBreakpointsValues;
...
function createTheme$1(options = {}, ...args) {
	const { breakpoints: breakpointsInput = {}, palette: paletteInput = {}, spacing: spacingInput, shape: shapeInput = {} } = options, other = _objectWithoutPropertiesLoose(options, _excluded$11);
...
function extendSxProp(props) {
	const { sx: inSx } = props;
	const { systemProps, otherProps } = splitProps(_objectWithoutPropertiesLoose(props, _excluded$10));
	let finalSx;
...
var _excluded$9 = ["className", "component"];
function createBox(options = {}) {
	...
	return /* @__PURE__ */ import_react.forwardRef(function Box(inProps, ref) {
		...
		const _extendSxProp = extendSxProp(inProps), { className, component = "div" } = _extendSxProp, other = _objectWithoutPropertiesLoose(_extendSxProp, _excluded$9);
...
init_createTheme();
init_styleFunctionSx();
var _excluded$8 = ["ownerState"], _excluded2 = ["variants"], _excluded3 = [
	"name",
	"slot",
...
function processStyleArg(callableStyle, _ref, layerName) {
	let { ownerState } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded$8);
...
function emphasize(color, coefficient = .15) {
	return getLuminance(color) > .5 ? darken$1(color, coefficient) : lighten$1(color, coefficient);
}
//#endregion
...
function RtlProvider(_ref) {
	let { value } = _ref, props = _objectWithoutPropertiesLoose(_ref, _excluded$7);
...
function createCssVarsProvider(options) {
	...
	function CssVarsProvider(props) {
		...
		const _ref = scopedTheme || themeProp, { colorSchemes = {}, components = {}, generateCssVars = () => ({
			vars: {},
			css: {}
		}), cssVarPrefix } = _ref, restThemeProp = _objectWithoutPropertiesLoose(_ref, _excluded$6);
...
function prepareCssVars(theme, parserConfig) {
	...
	const { vars: rootVars, css: rootCss, varsWithDefaults: rootVarsWithDefaults } = cssVarsParser(_objectWithoutPropertiesLoose(theme, _excluded$5), parserConfig);
...
function createContainer(options = {}) {
	...
	const Container = /* @__PURE__ */ import_react.forwardRef(function Container(inProps, ref) {
		...
		const { className, component = "div", disableGutters = false, fixed = false, maxWidth = "lg" } = props, other = _objectWithoutPropertiesLoose(props, _excluded$4);
...
//#endregion
export { init_createTheme as $, recomposeColor as A, identifier_default as At, init_getDisplayName as B, decomposeColor as C, require_prop_types as Ct, hexToRgb as D, init_objectWithoutPropertiesLoose as Dt, getLuminance as E, _objectWithoutPropertiesLoose as Et, useThemeProps as F, blue as Ft, ClassNameGenerator as G, generateUtilityClass as H, getThemeProps$1 as I, purple as It, extendSxProp as J, init_styleFunctionSx as K, resolveProps as L, red as Lt, init_clamp as M, orange as Mt, clamp as N, green as Nt, hslToRgb as O, _extends as Ot, useEnhancedEffect as P, lightBlue as Pt, createTheme_exports as Q, styled as R, common as Rt, darken$1 as S, require_jsx_runtime as St, getContrastRatio$1 as T, keyframes as Tt, createBox as U, getDisplayName as V, clsx as W, useTheme$1 as X, GlobalStyles as Y, useTheme$2 as Z, useRtl as _, init_deepmerge as _t, easing as a, getValue as at, exactProp as b, styled_engine_exports as bt, require_interopRequireDefault as c, capitalize_exports as ct, prepareCssVars as d, handleBreakpoints as dt, createTheme$1 as et, createGetCssVar as f, init_breakpoints as ft, useDefaultProps as g, deepmerge_exports as gt, DefaultPropsProvider as h, createBreakpoints as ht, duration as i, createUnarySpacing as it, rgbToHex as j, grey as jt, lighten$1 as k, init_extends as kt, createMixins as l, init_capitalize as lt, ThemeProvider as m, resolveBreakpointValues as mt, createMuiTheme as n, defaultSxConfig as nt, createTypography as o, init_spacing as ot, createCssVarsProvider as p, mergeBreakpointsInOrder as pt, styleFunctionSx_exports as q, createTheme as r, createSpacing as rt, require_colorManipulator as s, getPath as st, defaultTheme as t, styleFunctionSx as tt, createContainer as u, capitalize as ut, composeClasses as v, deepmerge as vt, emphasize as w, css as wt, alpha as x, StyledEngineProvider as xt, useId as y, init_styled_engine as yt, getDisplayName_exports as z };

//# sourceMappingURL=defaultTheme-Db9sKAcY.js.map